...
class _SidebarState extends State<_Sidebar> {
  ...
  double get _contentHeight {
    ...
    return y + _railGroupGap + _railItemH;
  }
                      ...
                      child: SizedBox(
                        ...
                        child: Stack(
                          children: [
                            ...
                            // the rows
                            Column(children: [
                              for (final r in _railRows) _row(r),
...
class _FullscreenRow extends StatelessWidget {
  final bool isFullscreen;
  final bool open;
  final VoidCallback onTap;
  const _FullscreenRow({required this.isFullscreen, required this.open, required this.onTap});

  @override
  Widget build(BuildContext context) {
    final icon = isFullscreen ? Icons.fullscreen_exit_rounded : Icons.fullscreen_rounded;
    final label = isFullscreen ? 'Exit Full Screen' : 'Full Screen';
    return FocusableTap(
      onTap: onTap,
        ...
        child: Stack(
          children: [
            ...
            Row(
              children: [
                SizedBox(
                  width: _railCollapsed,
                  child: Center(child: Icon(icon, size: 22, color: active ? textHi : muted)),
                ),
                Expanded(
                  child: ClipRect(
                    child: Row(
                      children: [
                        Expanded(
                          child: Text(label,
                              ...
                              softWrap: false,
                              style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14.5, color: active ? textHi : muted)),
                        ),
