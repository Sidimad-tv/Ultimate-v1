...
// "Sidimad-XtreamProv1" — a cyber-cyan accent system. Bright cyan reads
// cleanly on both a near-black dark canvas and a soft-white light canvas.
// Surfaces are solid; depth comes from a single neutral shadow.
...
const defaultAccent = Color(0xFF00E5FF); // cyber cyan
...
class ThemeController {
  ...
  static const _key = 'sidimad_theme_mode';

  static const _accentKey = 'sidimad_accent_color';
